...
{
  $secno = $_POST['search'];
  $sqlsearch = "SELECT * FROM `section` WHERE sec_ID = '".$secno."'";
  //echo $sqlsearch;
        ...
        <div class="row">
          ...
          <div class="col-md-15">
            ...
            <div style="width:1250px"class="card card-primary">
              ...
              <form name="formAdd" method="post" action="ptermsAdd.php">    <?php// echo $_SERVER['PHP_SELF']; ?>
                <div class="card-body">
                <div class="form-group">
                    <label for="SecNo">Section ID</label>
                    <input type="type" class="form-control" id="SecNo" value="<?php if(isset($secnumber)) { echo $secnumber; } ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="type" class="form-control" id="SecTitleMalay" value="<?php if(isset($sectionMalay)) { echo $sectionMalay; } ?>">
                  </div>
                  <div class="form-group">
                    <label for="SecTitleEng">Section (English)</label>
                    <input type="type" class="form-control" id="SecTitleEng" value="<?php if(isset($sectionEng)) { echo $sectionEng; } ?>">
                  </div>
                  <div class="form-group">
