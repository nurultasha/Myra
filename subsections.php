        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sub-Sections</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-15">
            ...
            <!-- add User form elements -->
              ...
              <div class="card-header">
                ...
                <p  align= "right">
                   <a href="subsectionsAdd.php"><input type="button" value="Add Sub-Sections"> </a> </p>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>#Sub-Section ID (auto increment)</th>
                  ...
                  <?php
                            ...
                            if($row > 0)
                            {
                              ...
                              ?><div class="btn-group">
                                <?php
                                echo  "<form action='subsectionsEdit.php' method = 'post'>
                                      ...
                                      <form action='subsectionsView.php' method = 'post'>
                                      <input type=\"hidden\" id=\"sec_ID\" name=\"sec_ID\" value=\"$d[sec_ID]\"/>
