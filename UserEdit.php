        ...
        <div class="row">
          ...
          <div class="col-md-15">
            ...
            <div style="width:1250px"class="card card-primary">
              ...
              p.USER_ID = u.USER_ID Join roles r ON p.role_ID = r.role_ID where p.USER_ID = '".$staffnumber."'";
              ...
              <form name="formAdd" method="post" action="pUserEdit.php">    <?php// echo $_SERVER['PHP_SELF']; ?>
                <div class="card-body">
                  <div class="form-group">
