        ...
        <div class="row">
          ...
          <div class="col-md-15">
            ...
            <div style="width:1250px"class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Terms</h3>
              </div>
              <?php
              if(isset($_POST['edit'])){
                $secID = $_POST['sec_ID'];
              ...
              <form name="formAdd" method="post" action="pSectionsEdit.php">    <?php// echo $_SERVER['PHP_SELF']; ?>
                ...
                <div class="form-group required">
                  ...
                  <div class="form-group">
                    ...
                    <input type="type" class="form-control" name="SecTitleMalay" id="SecTitleMalay" value="<?php if(isset($sectionMalay)) { echo $sectionMalay; } ?>">
                  </div>
                  <div class="form-group">
                    <label for="SecTitleEng">Section (English)</label>
                    <input type="type" class="form-control" name="SecTitleEng" id="SecTitleEng" value="<?php if(isset($sectionEng)) { echo $sectionEng; } ?>">
                  </div>
                  <!--<div class="form-group">-->
